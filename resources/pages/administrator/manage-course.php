            ...
            <div class="table-container">
                ...
                <div class="table">
                    <table>
                       ...
                       LEFT JOIN tblprofessor s ON f.facultyCode = s.faculty
                       LEFT JOIN tbldepthead l ON f.facultyCode = l.facultyCode
                       GROUP BY f.Id";
        ...
        <div class="formDiv" id="addUnitForm" style="display:none; ">
            <form method="POST" action="" name="addUnit" enctype="multipart/form-data">
                ...
                <select required name="depthead">
                    <option value="" selected>Assign depthead</option>
                    <?php
